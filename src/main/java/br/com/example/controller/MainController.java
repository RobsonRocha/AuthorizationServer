...
public class MainController {
	...
	@RequestMapping(value = "/rest/permission/alluserpermissions/{login}", method = RequestMethod.GET)
	@ResponseStatus( HttpStatus.OK )
	public @ResponseBody List<UserProfilePermission> getUserProfilePermissions(
		...
		if (user.isAdmin())
			...
			result = new ArrayList<UserProfilePermission>();
			result.add(this.userPermissions.get(user.getLogin()));
		}
		return result;
	}
	...
	@RequestMapping(value = "/rest/permission/updatepermission", method = RequestMethod.PUT)
	@ResponseStatus( HttpStatus.OK )
	...
	@RequestMapping(value = "/rest/permission/deletepermission", method = RequestMethod.DELETE)
	@ResponseStatus( HttpStatus.OK )
	public void deletePermission(@RequestBody ProfilePermission pp) {
	...
	@RequestMapping(value = "/rest/permission/desassociatepermission", method = RequestMethod.DELETE)
	@ResponseStatus( HttpStatus.OK )
	public ResponseEntity<String> desassociatePermission(
			@RequestBody UserProfilePermission up) {
		try {
	...
	@RequestMapping(value = "/rest/allusers/{login}", method = RequestMethod.GET)
	@ResponseStatus( HttpStatus.OK )
	public @ResponseBody List<User> getAllUsers(@PathVariable("login") String login) {
		...
		if (user.isAdmin()) {
			...
			result.add(this.users.get(user.getLogin()));
			return result;
		}
	}
	...
	@RequestMapping(value = "/rest/user/updateuser", method = RequestMethod.PUT)
	@ResponseStatus(HttpStatus.OK)
	...
	@RequestMapping(value = "/rest/user/deleteuser", method = RequestMethod.DELETE)
	@ResponseStatus(HttpStatus.OK)
	...
	@RequestMapping(value = "/rest/user/changepassword", method = RequestMethod.PUT)
	@ResponseStatus(HttpStatus.OK)
	...
	@RequestMapping(value = "/rest/user/deleterequestassociation/{login}", method = RequestMethod.DELETE)
	@ResponseStatus( HttpStatus.OK )
	...
	@RequestMapping(value = "/rest/user/deleterequestdesassociation/{login}", method = RequestMethod.DELETE)
	@ResponseStatus( HttpStatus.OK )
